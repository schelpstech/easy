...
try {
    ...
    foreach (['2026_08_29_stage1_logistics.sql', '2026_08_29_stage2_online_logistics.sql'] as $migration) {
    ...
    echo "Stage 2 database installed successfully: {$database}\n";
    echo "Configure real rate cards in Staff > Rates before accepting bookings.\n";
